...
function populateGradebook (data) {
    // This function will take the fetched grade data and pupulate the table
    ...
    let tableElm = document.getElementById("gradebook"); // Get the gradebook table element
        data.forEach(function(assignment){ // For each row of data we're passed in
            ...
            columns.grade.appendChild(
                ...
                // with either a bunch of condistions, or JavaScript "switch" statment
                document.createTextNode(assignment.total_grade)
            );
            // Add the table data columsn to the table row
